...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/wasmer-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/wasmer-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11776&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/wasmer-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_arm64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
It is possible to list all of the versions of `wasmer` available on your platform:
...
```
pixi search wasmer --channel conda-forge
```
